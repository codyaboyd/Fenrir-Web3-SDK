...
var qLoadContract1 = null;
var qLoadContract2 = null;
var qLoadContract3 = null;
var qBalance = null;


function quickLoadContract1(ql1Address,ql1Abi) {
	web3 = window.web3;
	qLoadContract1 = new web3.eth.Contract(ql1Abi, ql1Address);
	console.log(ql1Address + " Loaded");
}

function quickLoadContract2(ql2Address,ql2Abi) {
	web3 = window.web3;
	qLoadContract2 = new web3.eth.Contract(ql2Abi, ql2Address);
	console.log(ql2Address + " Loaded");
}

function quickLoadContract3(ql3Address,ql3Abi) {
	web3 = window.web3;
	qLoadContract3 = new web3.eth.Contract(ql3Abi, ql3Address);
	console.log(ql3Address + " Loaded");
}

function quickDeploy(qdAbi,qdBytecode) {
let qdContract = new web3.eth.Contract(qdAbi);
qdContract.deploy({
		data: qdBytecode,
...
async function quickBalance(qbUser) {
	let bal = await web3.eth.getBalance(qbUser);
	qBalance = web3.utils.fromWei(bal);
	console.log(qBalance);
}